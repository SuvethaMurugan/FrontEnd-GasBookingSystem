...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,CustomerComponent,RouterLink,FormsModule,CommonModule,HeaderComponentComponent,AddCylinderComponent,FooterComponent,HomeComponent,CylinderFunctionalityComponent,AllCylindersComponent],
